...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => PATH_MAIN.$this->get_request_var('upload_dir'),
            'upload_url' => $this->get_request_var('upload_url'),
       		
/*        		'script_url' => 'http://alphaweb/DEV/SANTOS/WRS/api/jQueryFileUpload/oficial/server/php/index.php',
  ...
  */      		
    ...
    //By Marcelo Santos
    protected function get_request_var($id) {
    	return @$_REQUEST[$id];
    }
