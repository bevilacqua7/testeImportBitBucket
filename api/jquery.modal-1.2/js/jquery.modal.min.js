...
(function(e) {
	e.cModal = function(t) {
		var n = {
			...
			zIndex : 1050,
			_class	:	null,//Adicionado por Marcelo - WRS
			buttonText : {
				ok : LNG('MODAL_OK'),
				yes : LNG('MODAL_YES'),
				cancel : LNG("MODAL_CANCEL")
			},
			template : '<div class="modal-box "><div class="modal-inner"><div class="modal-title"><a class="modal-close-btn"></a></div><div class="modal-text"></div><div class="modal-buttons"></div></div></div>',
			_classes : {
				box : ".modal-box",
				boxInner : ".modal-inner",
				title : ".modal-box .modal-title",
				content : ".modal-text",
				buttons : ".modal-buttons",
				closebtn : ".modal-close-btn"
			}
		}, t = e.extend({}, n, t), r, i = e("<div id='modal-window' />").hide(), s = t._classes.box, o = i
				.append(t.template), u = {
			init : function() {
				...
				/*
				 * Adicionado por Marcelo Santos Uso WRS
				 */
			...
			_keyUpF : function(e) {
				switch (e.keyCode) {
				case 13:
					if ($("input:not(.modal-prompt-input),textarea").is(
							":focus")) {
						return false
					}
					u._modalBtn(i.find(t._classes.buttons
							+ " a.modal-btn"
							+ (typeof u.btnForEKey !== "undefined"
									&& i.find(
											t._classes.buttons
													+ " a.modal-btn:eq("
													+ u.btnForEKey + ")")
			...
			_modalHide : function(n) {
				...
				var o = function() {
					...
					var n = 100 * parseFloat(e(s).css("top"))
							/ parseFloat(e(s).parent().css("height"));
			...
			_modalConent : function() {
				...
				var n = t._classes.title, r = t._classes.content, o = t._classes.buttons, a = t.buttonText, f = [
						"alert", "confirm", "prompt" ], l = [ "xenon",
						"atlant", "reseted" ];
				
				if (e.inArray(t.wrs_type, f) == -1 && t.wrs_type != "default") {
					e(s).addClass("modal-type-" + t.wrs_type)
				}
				...
				if (t.theme && t.theme != null && t.theme != "default") {
					e(s).addClass(
							(e.inArray(t.theme, l) == -1 ? "" : "modal-theme-")
									+ t.theme)
				}
				...
				t.type == "prompt" ? t.text += '<input type="text" name="modal-prompt-input" class="modal-prompt-input" autocomplete="off" autofocus="on" />'
						: "";
				e(r).html(t.text);
				if (t.buttons || t.buttons != null) {
					...
					case "confirm":
						c = '<a class="modal-btn'
								...
								+ a.cancel
								+ '</a><a class="modal-btn '
								+ (t.buttons[1] && t.buttons[1].addClass ? " "
										+ t.buttons[1].addClass
										: "btn-light-blue") + '">' + a.yes
								+ "</a>";
						break;
					case "prompt":
						c = '<a class="modal-btn'
						...
						if (t.buttons.length > 0 && e.isArray(t.buttons)) {
							e
									.each(
											...
											function(e, t) {
												var n = t["addClass"]
														&& typeof t["addClass"] != "undefined" ? " "
														+ t["addClass"]
														: "";
												c += '<a class="modal-btn' + n
														+ '">' + t["text"]
														+ "</a>";
												if (t["eKey"]) {
													u.btnForEKey = e
				...
				if (t.autoclose) {
					var h = t.buttons || t.buttons != null ? e(r).text().length * 32
							: 900;
			...
			_position : function() {
				...
				if (t.center) {
					n = {
						top : 50,
						left : 50,
						marginTop : -e(s).outerHeight() / 2,
						marginLeft : -e(s).outerWidth() / 2
					};
					if (e(window).height() < e(s).outerHeight()) {
						n.top = 1;
						n.marginTop = 0
					}
					e(s).css({
			...
			_modalBtn : function(n) {
				var s = false, o = t.type, a = n.index(), f = t.buttons[a];
				if (e.inArray(o, [ "alert", "confirm", "prompt" ]) > -1) {
					s = a == 1 ? true : false;
					if (o == "prompt") {
						s = s
								&& i.find("input.modal-prompt-input").size() > 0
								&& i.find("input.modal-prompt-input").val().length != 0 ? i
								.find("input.modal-prompt-input").val()
								: false
					}
					u._modalHide()
				} else {
