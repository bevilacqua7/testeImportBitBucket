...
includeQUERY('ATT_WRS_PERFIL');

class ATT_WRS_PERFIL extends WRS_BASE
{
	private $admin = NULL;
	
	public function __construct(){
		$this->admin = new WRS_AdminInterface();
		$this->admin->classname = 'ATT_WRS_PERFIL';
		$this->queryClass		 = new QUERY_WRS_PERFIL();
	}
	...
	public function update($options)
	{
		...
		$query_exec = $this->queryClass->Get_query_changetable_perfil($_tabela, $arr_campos_valores, ($acao_form=='UPDATE'?implode(' and ',$primaries):''), $acao_form);
	...
	public function delete($options)
	{
		...
		foreach($_regForDelete['objetosSelecionados'] as $id_for_del){
			...
			$query_exec = $this->queryClass->Get_procedure_remove_perfil($_tabela, $condicao_query);
