...
class KendoUi
{
	...
	{
		return array('page_size','PLUS_MINUS','ORDER_BY_COLUMN','ORDER_COLUMN_TYPE','frozen','SUMARIZA','COLORS_LINE','ALL_COLS','ALL_ROWS','WINDOW','CHART','GAUGE_COLOR','GAUGE_SIZE_BY_LINE','BUBBLE_SHOW_TOTAL');	
	}
	...
	private function buildTelerikKendo()
	{
		...
		$_param['pageable']		=	 array(	'refresh'	=>	false,
											'pageSizes'	=> 	array(25,50,100,200,500,1000),
											'input'		=>	true,
											'numeric'	=>	false);
