...
/**
 * CLASS PARA CONEX�O COM O SQL SERVER
 * 
...
class SQL_SERVER
{
	...
	/**
	 * Conex�o de Banco Apenas executado quando n�o chamado a conex�o mas deve ser chamado apenas para o define 
	 * TODO:Apenas use quando souber o que est� fazendo
	 */
	public function runConnection()
	{	
		$connectionInfo = array("Database"=>BANCO,'UID'=>USUARIO,'PWD'=>SENHA, "CharacterSet"  => CODE);
	...
	/**
	 * retorna a execu��o da consulta no SQL Server
